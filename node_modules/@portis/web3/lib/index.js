...
var widgetManager_1 = require("./widget/widgetManager");
var web3Manager_1 = require("./web3/web3Manager");
var isClientSide_1 = require("./utils/isClientSide");
var mockify_1 = require("./utils/mockify");
var VERSION = '4.1.0';
var SUPPORTED_SCOPES = ['email', 'reputation'];
onWindowLoad_1.onWindowLoad()
    .then(widgetManager_1.windowLoadHandler)
...
var Portis = /** @class */ (function () {
    function Portis(dappId, network, options) {
        ...
        if (!isClientSide_1.isClientSide()) {
            return mockify_1.mockify(this);
        }
        ...
        this._web3ManagerInstance = new web3Manager_1.default(this.config, this._getWidgetCommunication);
    ...
    Portis.prototype.purchaseERC20 = function (tokenAddress, amount, tokenSymbol, logoURL) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this._widgetManager.purchaseERC20({ tokenAddress: tokenAddress, amount: amount, tokenSymbol: tokenSymbol, logoURL: logoURL })];
            });
        });
    };
    // internal methods
