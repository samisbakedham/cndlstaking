    ...
    <>
      ...
      <Accordion w="full" allowToggle>
            ...
            <OrderedList>
              <ListItem>
                ...
                <Link
                  ...
                  isExternal
                >{`Uniswap v3 "Add Liquidity" page for CNDL & USDC.`}</Link>
              </ListItem>
        ...
        <AccordionItem>
          ...
          <AccordionPanel pb={4}>
            <Text>When you stake your NFT, your NFT will be temporarily held on the Staker contract. This gives it the ability to earn CNDL rewards for providing liquidity. When you Exit, the NFT will be returned back to your wallet.</Text>
            <br/>
        ...
        <AccordionItem>
          ...
          <AccordionPanel pb={4}>
            <Text>{`Yes, this website is affiliated with the CNDL core team. It was created to help people navigate the somewhat confusing Uniswap V3 Staker design. Be safe and double check your TXs before you send them.`}</Text>
            <br />
